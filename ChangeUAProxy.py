...
class ChangeUAProxyHandler(SimpleHTTPProxyHandler):
    def request_handler(self):
        self.headers['User-Agent'] = 'Mozilla/5.0 (iPhone; CPU iPhone OS 6_0 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Version/6.0 Mobile/10A403 Safari/8536.25'
